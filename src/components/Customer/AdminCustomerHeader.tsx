...
import CreateClassifiedDialog from "../Admin/Classified/CreateClassifiedDialog";

const AdminCustomerHeader = ({ searchParams }: AwaitedPageProps) => {
  // console.log(ClassifiedStatus);
  return (
    <div className=" flex  flex-col p-6 space-y-4 text-muted">
      <div className="flex items-center justify-between">
        <h1 className=" font-semibold text-lg md:text-2xl">All Customer</h1>
        <div className=" flex items-center justify-between">
          <Radio
